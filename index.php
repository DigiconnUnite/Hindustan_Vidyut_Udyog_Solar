...
<?php $heroSlides = ['/assets/images/hero-section-1.png', '/assets/images/hero-section.png', '/assets/images/pm-surya-ghar-banner.png']; ?>
<section id="hero" class="relative overflow-hidden h-[70vh] md:h-[85vh]">
  <?php foreach ($heroSlides as $i => $slide): ?>
    <div data-hero-slide class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 <?= $i ? 'opacity-0' : '' ?>"
         style="background-image:url('<?= e($slide) ?>')"></div>
  <?php endforeach; ?>
