...
<footer class="bg-[#03130a] rounded-3xl m-3 text-gray-300 mt-20">
  <div class="mx-auto container px-6 md:px-10 pt-14 pb-8">
    ...
    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-10">
      <div class="flex items-center gap-3">
        <span class="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-lime-400 text-[#03130a]"><?= icon('sun', 'h-6 w-6') ?></span>
        <div>
      ...
      <div class="w-full md:w-auto md:min-w-[380px]">
        ...
        <form class="flex items-center gap-2 rounded-full border border-lime-400/40 bg-[#03130a] p-1.5 pl-5">
          ...
          <button type="button" class="rounded-full bg-lime-400 px-6 py-2.5 text-sm font-semibold text-[#03130a] hover:bg-lime-300 transition">
            Subscribe
          </button>
        </form>
      </div>
    ...
    <div class="grid gap-10 md:grid-cols-4 py-10">
      <div>
        ...
        <div class="flex items-center gap-3 mt-6">
          <a href="#" aria-label="Facebook" class="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-lime-400 text-[#03130a] hover:bg-lime-300">
            <?= icon('facebook', 'h-4 w-4') ?>
          </a>
          <a href="#" aria-label="Twitter" class="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-lime-400 text-[#03130a] hover:bg-lime-300">
            <?= icon('twitter', 'h-4 w-4') ?>
          </a>
          <a href="#" aria-label="YouTube" class="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-lime-400 text-[#03130a] hover:bg-lime-300">
      ...
      <div>
        <h4 class="font-semibold text-lime-400 mb-4">Quick Links</h4>
      ...
      <div>
        <h4 class="font-semibold text-lime-400 mb-4">Admin</h4>
        <ul class="space-y-3 text-sm">
      ...
      <div>
        <h4 class="font-semibold text-lime-400 mb-4">Contact Information</h4>
        <ul class="space-y-4 text-sm">
          <li class="flex items-start gap-3">
            <span class="mt-0.5 text-lime-400"><?= icon('map-pin', 'h-4 w-4') ?></span>
            <span class="text-white font-medium"><?= e(setting('company_address', 'India')) ?></span>
          </li>
          <li class="flex items-center gap-3">
            <span class="text-lime-400"><?= icon('mail', 'h-4 w-4') ?></span>
            <span class="text-white font-medium"><?= e(setting('company_email', 'info@hvusolar.com')) ?></span>
          </li>
          <li class="flex items-center gap-3">
            <span class="text-lime-400"><?= icon('phone', 'h-4 w-4') ?></span>
    ...
    <div class="border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-500">
      ...
      <div class="flex items-center gap-4">
        ...
        <span>|</span>
        <a href="/contact.php" class="hover:text-gray-300">FAQ</a>
      </div>
    </div>
  </div>
</footer>
